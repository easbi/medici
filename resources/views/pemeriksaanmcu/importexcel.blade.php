                	...
                	<div class="info-box">
						...
						<div class="modal fade" id="importExcel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
							<div class="modal-dialog" role="document">
								<form action="{{route('pemeriksaanmcu.import_excel')}}" method="POST" enctype="multipart/form-data">
            	...
            	<div class="col-12 col-sm-6 col-md-6">
                	<div class="info-box">                		
	                    ...
	                    <div class="info-box-content">
	                        ...
	                        <span class="info-box-number"><a href="{{route('pemeriksaanmcu.export_excel')}}" class="btn btn-success" target="_blank">EXPORT EXCEL</a></span>
	                    </div>						
					</div>
				</div>
			</div>
            	...
            	<div class="col-12 col-sm-6 col-md-6">
                	<div class="info-box">
						...
						<div class="modal fade" id="importExcel2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel2" aria-hidden="true">
							<div class="modal-dialog" role="document">
								<form action="{{route('pemeriksaannonmcu.import_excel')}}" method="POST" enctype="multipart/form-data">
									<div class="modal-content">
										<div class="modal-header">
            	...
            	<div class="col-12 col-sm-6 col-md-6">
                	<div class="info-box">                		
	                    ...
	                    <div class="info-box-content">
	                        ...
	                        <span class="info-box-number"><a href="{{route('pemeriksaannonmcu.export_excel')}}" class="btn btn-success" target="_blank">EXPORT EXCEL</a></span>
	                    </div>						
					</div>
				</div>
			</div>
